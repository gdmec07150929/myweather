package com.gourd.adien.myweather;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initProvinces();
        initChooseDialog();
        settingBtn = (ImageView) this.findViewById(R.id.setting);
    ...
    public  void initChooseDialog(){
        choose_dialog = new AlertDialog.Builder(seft).setTitle("选择城市").setPositiveButton("确定",new ChooseCityListener())
